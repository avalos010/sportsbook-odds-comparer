    ...
    <header className="sticky top-0 z-40 bg-white border-b dark:bg-neutral-950">
      ...
      >
        ...
        <aside
          ...
          className={`absolute left-0 top-0 h-full w-full max-w-sm bg-white/95 dark:bg-neutral-900/95 backdrop-blur-sm border-r border-slate-200 dark:border-neutral-800 shadow-xl p-4 transform transition-transform ${
